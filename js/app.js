 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".client-gallery-swiper__slider")) new core(".client-gallery-swiper__slider", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
                ...
                loop: true,
                pagination: {
                    el: ".client-gallery-swiper__swiper-pagination",
                    clickable: true
                },
                breakpoints: {
                    320: {
            ...
            if (document.querySelector(".story__slider")) var bigSlider = new core(".story__slider", {
                modules: [ Thumb, Pagination, Controller ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                spaceBetween: 0,
            ...
            if (document.querySelector(".thumbs-story__slider")) var thumbSlider = new core(".thumbs-story__slider", {
                modules: [ Thumb, Controller ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
                centeredSlides: false,
                ...
                speed: 500,
                pagination: {
                    el: ".thumbs-story__swiper-pagination",
                    clickable: true
                },
                breakpoints: {
                    320: {
            ...
            bigSlider.controller.control = thumbSlider;
            thumbSlider.controller.control = bigSlider;
        }
...
***************************************************************************** */
            ...
            galleries.forEach((gallery => {
                galleryItems.push({
                    ...
                    galleryClass: lightgallery_es5(gallery, {
                        ...
                        speed: 500,
                        selector: ".gallery-images__image-ibg"
                    })
                });
            }));
        ...
        if (document.querySelector(".video-module")) {
            ...
            document.querySelector(".video-module").addEventListener("click", (function(e) {
                ...
                } else if (document.querySelector(".video-module").querySelector("video").paused) {
                    document.querySelector(".video-module").querySelector("video").play();
                    document.querySelector(".video-module").classList.add("_active");
                } else {
                    document.querySelector(".video-module").querySelector("video").pause();
                    document.querySelector(".video-module").classList.remove("_active");
                }
            }));
        }
        window["FLS"] = true;
